            ...
            <div class="container-fluid p-2">
                <div class="row justify-content-center">
                    <div class="col-12 col-md-6">
                        <form class="card p-5" name="register" action="user_register_validate.php" method="POST">
                            <h1 class="text-center py-3">CREATE AN ACCOUNT</h1>
                            <div class="mb-3">
                                <label for="userfname" class="form-label">Firstname</label>
                                <input type="text" name="userfname" required class="form-control" id="userfname">
                            </div>
                            <div class="mb-3">
                                <label for="userlname" class="form-label">Lastname</label>
                                <input type="text" name="userlname" required class="form-control" id="userlname">
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="usermobile" required class="form-control" id="usermobile">
                            </div>
                            <button type="submit" class="btn btn-primary" name="rgstr">Register</button>
